...
import { SiVercel, SiNetlify, SiPostman, SiCodesandbox, SiCodepen } from 'react-icons/si';
    ...
    <section className="py-5 py-md-5">
      <Container>
        <h2 className="text-center mb-5 d-flex align-items-center justify-content-center">
          <SiCodepen size={30} className="me-2 text-primary" style={{ verticalAlign: 'middle' }} />
          Technical Skills
        </h2>
